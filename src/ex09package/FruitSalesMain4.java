...
//		* 생성자를 정의하였으므로, 각각 성격이 다른 객체들을 생성할 수 있다.
		// 판매자1
		FruitSeller4 seller1 = new FruitSeller4(0, 100, 1000, "seller1");
		// 판매자2
		FruitSeller4 seller2 = new FruitSeller4(0, 80, 500, "seller2");
		
		
		FruitBuyer4 buyer = new FruitBuyer4(10000, 0, "buyer");
