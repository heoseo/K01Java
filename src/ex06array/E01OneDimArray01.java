...
/*		* 배열
		 - 자바에서는 배열을 객체를 통해 생성한다.
		       생성된 배열은 heap영역에 저장되고, 할당된 메모리의 주소값을 반환한다.
		       그래서 배열명(배열변수)는 주소값(참조값)을 할당받는다.
		       해당 주소를 통해 배열에 접근한다.
*/
		...
		System.out.println("배열명(numArr)=" + numArr);	// [I@52af6cff
...
/*
		배열의 선언과 동시에 초기화를 하는 경우 자바 컴파일러는 초기값의 개수를 통해 
