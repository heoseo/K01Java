 ...
 */
		...
		// 난수생성방법2
/*
		Random 클래스 : Scanner 클래스와 동일한 nextInt() 함수를 이용해서 
					정수형 난수를 생성한다.
 */
...
/*
		...
		1. 0.xxxx형태의 난수를 정수로 변환하기 위해 100을 곱한 후 int로 형변환한다.
		2. 45로 % 연산하여 나머지를 구한다. 이 떄 결과는 0~44가 된다.
		3. 2번의 결과에 +1 한다. 결과적으로 1~45 사이의 난수를 생성할 수 있다.
 */
