...
/*
			[시나리오1]
			1~100까지의 합을 구하는 프로그램을 for문을 이용하여 구현하시오.
 */
...
/*
			[시나리오2]
			for문을 이용하여 1~10 사이의 정수 중 2의 배수의 합을 구하는 프로그램을 작성하시오.
 */
...
/*
		for문의 끝에 ; 을 사용하면 반복할 문장이 없는 것으로 간주하여
...
/*
 		for문의 초기값을 외부(넓은지역)에서 선언하면 해당 변수는 for문 안쪽 (좁은지역)에서
...
//		=======================================================================================
		...
		System.out.println("(1) 증가 연산자 사용으로 구현");
		for(int x = 1; x <= 4; x++) {
			for(int y = 1; y <= 4; y++) {
				if(x+y == 5)
					System.out.print("1 ");
		...
		System.out.println("(2) 감소 연산자 사용으로 구현");
		for(int x = 1; x <= 4; x++) {
			for(int y = 4; y >= 1; y--) {
				if(x == y)
					System.out.print("1 ");
