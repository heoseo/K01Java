...
1. 패키지 선언부 : 클래스를 종류별로 묶어서 관리하기위한 선언으로
디렉토리의 의미로 이해해도 된다.
 */
package ex01javastart;

/*
 2. import 선언부 : 내가 만든 클래스에서 필요한 자바클래스를 가져다 쓰기 위한 선언으로
 				  JDK에서 제공하는 클래스를 사용할 수도 있다.
 */
import java.text.SimpleDateFormat;
import java.util.Date;
/*
3. 클래스 선언부 : 	자바프로그램은 클래스단위로 구성되므로 기본적으로 필요한 부분으로
...
public class JavaStruct {
	...
	public static void main(String[] args) {
		...
		/*
		SimpleDateFormat 클래스를 이용하여 우리가 흔히 사용하는 날짜 포맷인
		년-월-일 시:분:초 형태로 변환하여 출력함.
		 */
		SimpleDateFormat simple = new SimpleDateFormat("yyyy:MM월:dd HH:mm:ss");
