...
/*
 		* Method(메소드)
 			...
 			즉 어떤 하난의 업무를 처리하는 모듈(부속품)이라 정의할 수 있다.
 		* 규칙
		...
		* Java에서의 Naming Rule(이름 규칙)
			...
			- 상수 : SIMPLE_FUNC -> 전체를 대문자로 표현하고, 단어 사이는 언더바를 사용
...
public class E02MethodType01 {
	...
	static void noParamNoReturn() {				//* 메소드 형식1
		System.out.println("==메뉴를 선택하세요==");		// : 매개변수도 없고 반환값도 없는 경우
	System.out.println("1.열기 2.계속하기 3.종료");		// - 해당 형식은 주로 출력을 담당하는 기능으로 사용된다.
		System.out.println("=====================");//	   반환타입은 반드시 void로 기술해야 한다.
	}
...
//		return;
		...
		아래 문장은 실행되지 않는 쓰레기코드가 된다. 반드시 조건문~~
		 */
