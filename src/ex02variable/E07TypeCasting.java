...
/*
 			* 자동형변환
 			  : 작은 상자의 데이터를 큰 상자에 대입할 때 자동으로 형변환이 일어난다.
 */
		byte b1 = 65;
		short s1;
		s1 = b1;	// byte형 < short형, short <= byte
...
/*
 			* 명시적 형변환 : 큰 상자의 자료를 작은 상자의 자료형에 할당햏야할 때 사용함.
...
/*
			...
			따라서 특수한 경우가 아니라면 사용으 랒제해야 함.
 */
		int num3;
		double dl = 3.14;
		num3 = (int)dl;
		System.out.printf("데이터 미손실 : num3 = %d, dl = %.2f %n", num3, dl);
