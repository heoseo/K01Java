...
/*
			...
			* 선언 방법 : final 자료형 변수명 = 초기값;
			 - 상수는 딱 한 번만 초기화되고, 중간에 값을 변경하면 에러가 발생
			 - 선언시 전체를 대문자로 선언하고, 연결되는 단어가 있는경우 _(언더바)를 사용한다.
...
//		1과 3은 개발자 본인만 알 수 있는 내용이므로, 가독성이 떨어지는 코드가 된다.
		computer = 1;
		user = 3;
		System.out.println("컴퓨터가 이겼습니다.");
		
//		PAPER와 같은 단어는 누가 봐도 이해할 수 있으므로 가독성이 높은 명시적인 코드가 된다.
		computer = SCISSOR;
		user = PAPER;
