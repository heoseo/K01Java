...
public class StaticBlock {
	...
	static {
		...
		/*
		static 블럭 내에서만 사용할 수 있는 변수로써, 이 때는 일반적인 변수를 생성할 수 있다.
		 */
		int localVar;
		localVar = 1000;
...
//		System.out.println("instatnceVar = " + instanceVar);
//		instanceMethod();
...
// 	주석으로 처리한 후 Eo2StaticBlockMain.java에서 실행할 것.
	public static void main(String[] args) {
		
		System.out.println("==메인메소드==");
		
		// static 블럭 내에서 선언된 지역변수이므로 main에서는 사용불가
//		System.out.println("localVar = " + localVar);
