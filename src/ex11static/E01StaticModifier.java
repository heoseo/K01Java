...
/*
	* static variable (정적변수)
	 ...
	 - 접근방법
	 	클래스 내부 : 변수명으로 접근 가능(일반적인 멤버변수와 동일함)
...
public class E01StaticModifier {
	...
	public static void main(String[] args) {
		...
		/*
		인스턴스형 멤버변수는 객체 별로 각각 존재하므로 아래 초기화된 값은 객체별로 각각 저장된다.
		따라서 출력결과 는 100,, 1000이 된다.
		 */
		ms1.instanceVar = 100;
		...
		/*
		정적 멤버변수는 가각의 객체마다 멤버변수가 존재하지 않고, 메소드 영역에 하나만 생성되어 공유하믈,
		아래 대입문장으 ㄴ하나의 변수에 값이 할당된다. 따라서 결과는 둘 다 900이 출력된다.
		 */
		...
		/* 
		정적 멤버메소드의 접근 방법은 정적변수의 접근방법과 동일하다.
		 */
